...
-include vendor/zte/v9plus/BoardConfigVendor.mk
...
BOARD_EGL_CFG := device/zte/v9plus/prebuilt/lib/egl/egl.cfg
...
TARGET_PREBUILT_KERNEL := device/zte/v9plus/recovery_kernel
TARGET_RECOVERY_INITRC := device/zte/v9plus/recovery/etc/init.rc
